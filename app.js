    ...
    card.innerHTML = `
        ...
        <div class="card-body">
          ...
          <div>
              ...
              flex-shrink: 0;
              border-radius: 40px;
background: url(<path-to-image>), lightgray 50% / cover no-repeat;" src=${
      singelData.authors[0].profile_picture
    } alt="" srcset="">
          </div>
          <div class="mx-5">
          ...
          flex-shrink: 0;">
          ${
            singelData.authors[0].verified
              ? '<img src="./Design in png/tik.png" style="" alt="">'
              : ""
          }
          </span>
              </p>
